...
export async function createSession(hostName, location, searchRadiusMiles) {
    ...
    const session = await SessionModel.createSession(sessionCode, tempHostId, hostName, location, searchRadiusMiles);
