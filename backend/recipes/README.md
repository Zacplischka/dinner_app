...
**Structural, culinary and tally pass; the human layer waits on a reader.**
Against #338's six acceptance criteria:

| #   | Criterion                                                                                  |                                                                                                                                                                          |
| --- | ------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| 1   | All 50 through the four-layer gate, tally at 1101                                          | **Structural, culinary and tally done; human open** — see the table above                                                                                                |
...
What stays open is a person: a reader for the human layer. Closing #338 wants
that; committing this batch does not.
