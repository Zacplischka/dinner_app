...
# the Google Places restaurant search (catches expired/broken Places API
# keys), and a Watch create dealt from the committed movie corpus (#369). The
# sessions it creates are throwaway; Redis TTL expires them in 30 minutes.
set -euo pipefail
