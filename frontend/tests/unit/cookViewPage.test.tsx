...
describe('CookViewPage', () => {
  it('restores cooking progress from one bounded list record after reopening', async () => {
    ...
    expect(sessionStorage.getItem('heykeen.cook-progress')).toContain('"steps":[0]');
    first.unmount();
    renderPage();
    ...
    expect(Object.keys(sessionStorage)).toEqual(['heykeen.cook-progress']);
  });
