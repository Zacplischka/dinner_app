                    ...
                    <div className="mt-2 space-y-2">
                        ...
                        <div className="flex flex-wrap gap-3 pt-3 mt-1 border-t border-line/20">
                          ...
                          >
                            ...
                            <svg className="w-3 h-3 text-muted/50 group-hover:text-[#06C167]/70 group-hover:translate-x-0.5 group-hover:-translate-y-0.5 transition-all duration-300" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                          ...
                          >
                            ...
                            {/* External link indicator */}
                            <svg className="w-3 h-3 text-muted/50 group-hover:text-[#FF3008]/70 group-hover:translate-x-0.5 group-hover:-translate-y-0.5 transition-all duration-300" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                              <path strokeLinecap="round" strokeLinejoin="round" d="M4.5 19.5l15-15m0 0H8.25m11.25 0v11.25" />
                            </svg>
                          </a>
                        </div>
        ...
        <div className="card mb-6">
          ...
          <div className="space-y-4">
            {participants.map((participant, participantIndex) => {
              ...
              return (
                <div key={participant.participantId} className="border-b border-line/30 pb-4 last:border-b-0 last:pb-0">
                  <div className="flex items-center space-x-2 mb-2">
                    <div className={`w-8 h-8 bg-surface border-2 rounded-full flex items-center justify-center text-text text-sm font-semibold ${participantRingClass(participantIndex)}`}>
